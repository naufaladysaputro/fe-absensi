...
const navigation = [
  ...
  { name: 'Absensi Siswa', href: '/absensi', icon: ClipboardDocumentListIcon },
  { name: 'Data Siswa', href: '/siswa', icon: UserGroupIcon },
  { name: 'Data Kelas & RomBel', href: '/kelas', icon: AcademicCapIcon },
  { name: 'Generate QR Code', href: '/qrcode', icon: QrCodeIcon },
  { name: 'Generate Laporan', href: '/laporan', icon: DocumentTextIcon },
  { name: 'Data Petugas', href: '/petugas', icon: UsersIcon },
  { name: 'Pengaturan', href: '/pengaturan', icon: Cog6ToothIcon },
];
